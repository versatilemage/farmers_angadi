...
const CommonNavBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-primary shadow-lg transition-all duration-300 ease-in-out backdrop-blur-md">
            ...
            <li>
              <Link href="/cart">
                <svg
                  ...
                  height="2em"
                  viewBox="0 0 24 24"
                  className="bg-secondary rounded-full w-10 h-10 p-2 hover:bg-tertiary"
                >
                  <path
                    fill="green"
      ...
      {isOpen && (
        <>
          <div className="fixed z-10 w-full h-full min-h-screen min-w-[100vw] bg-stone-400/70" onClick={() => setIsOpen(false)}></div>
          <div className="absolute top-[4em] left-0 w-full bg-gray-400 p-6 z-50 flex flex-col items-center gap-4">
