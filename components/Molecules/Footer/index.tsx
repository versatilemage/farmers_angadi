        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link
                target="_blank"
                href="https://www.facebook.com/share/1A14sBwUeN/"
              ...
              <Link
                target="_blank"
                href="https://www.instagram.com/farmersangadi?igsh=cG9pbTNkcDVycTR4"
                className="hover:text-white transition-colors"
              >
                <Instagram size={20} />
              </Link>
              <Link
                target="_blank"
                href="https://youtube.com/@farmersangadi?si=DcB_SWRs85xeKzYC"
                className="hover:text-white transition-colors"
              >
                <Youtube size={20} />
              </Link>
              <Link target="_blank" href={"https://wa.me/918838521634"}>
                <svg
                  fill="#FFFFFF"
                  height="1.25em"
                  width="1.25em"
